...
import CaregiverProfileContent from '../../src/features/caregiver/components/CaregiverProfileContent';
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F8FAFF]" edges={['left', 'right']}>
      ...
      <View style={{ flex: 1 }} className="overflow-hidden">
        ...
        {/* Fixed — no movement */}
        <CaregiverTopBarLayout title="My Profile" />

        {/* Only content animates in */}
        <CaregiverProfileContent anim={listAnim} />

        {/* Fixed — no movement */}
        <CaregiverBottomBarLayout active={'profile' as CaregiverTabName} />
